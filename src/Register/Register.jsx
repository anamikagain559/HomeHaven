...
function Register() {
  ...
  return (
    <main className="">
      <Navbar></Navbar>
      <div className="bg-gradient-to-t from-[#bce6e4] to-[#f8fdfe] min-h-screen flex justify-center items-center p-5">
        <div className="bg-white shadow-2xl rounded-3xl py-8 w-full max-w-md relative">
          ...
          <Link to="/login" className="font-bold text-[#329c9c]">Login</Link>
